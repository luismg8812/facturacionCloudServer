...
class DocumentoControllers {
    ...
    public async getCuadreCaja(req: Request, res: Response): Promise<any> {
        ...
        let query: string = "select total_facturas,total_notas,efectivo,documentos_no_impresos, abonos,tarjetas, cheques,vales,consignaciones,cartera,retiro_caja from"
