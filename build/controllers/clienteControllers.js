...
class ClienteControllers {
    ...
    saveCliente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query(query, [cliente_id, nombre, apellidos, documento, barrio, direccion, celular, fijo, fecha_registro, credito_activo, mail, empresa_id, tipo_identificacion_id, segundo_nombre, segundo_apellido, fact_tipo_empresa_id, razon_social, digito_verificacion]).then(res2 => {
    ...
    updateCliente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(query);
            yield database_1.default.query(query, [nombre, apellidos, documento, barrio, direccion, celular, fijo, fecha_registro, credito_activo, mail, empresa_id, tipo_identificacion_id, segundo_nombre, segundo_apellido, cliente_id, fact_tipo_empresa_id, razon_social, digito_verificacion]).then(res2 => {
                res.json({ "code": 200, "cliente_id": cliente_id });
            }).catch(error => {
                console.error(error);
